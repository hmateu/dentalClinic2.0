...
const appointmentUpdateByPatientController = {}

appointmentUpdateByPatientController.updateAppointmentByPatient = async (req, res) => {
    try {
...
module.exports = appointmentUpdateByPatientController;